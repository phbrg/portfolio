...
const Projects = () => {
  return (
    <div className='Projects'>
      ...
      <Card title = 'market-manager' description = 'An node.js market ( shop/store ) manager, with an interactive dashboard and many functions' source = 'https://github.com/phbrg/market-manager' skills = {[{icon: <i class="fa-brands fa-js"></i>, name: 'Javascript'}, {icon: <i class="fa-brands fa-node-js"></i>, name: 'Node.js'}, {icon: <i class="fa-solid fa-database"></i>, name: 'PostgreSQL'}]} />
      <Card title = 'restaurant-manager' description = 'A restaurant management web application focused on facilitating customer orders and restaurant organization' source = 'https://github.com/phbrg/restaurant-manager' skills = {[{icon: <i class="fa-brands fa-js"></i>, name: 'Javascript'}, {icon: <i class="fa-brands fa-node-js"></i>, name: 'Node.js'}, {icon: <i class="fa-solid fa-database"></i>, name: 'PostgreSQL'}]} />
      ...
      <h2 className='subtitle'>You can find many more of my projects  <a href="https://github.com/phbrg?tab=repositories" target="_blank">here</a></h2>
    </div>
  )
}
