...
const Projects = () => {
  return (
    <div className='Projects'>
      ...
      <Card title='Market Manager' date='Jan, 2024 - Now days' description='An node.js market ( shop/store ) manager, with an interactive dashboard and many functions.' tags={['Node.js', 'React.js', 'PostgreSQL']} link='https://github.com/phbrg/market-manager' blank={true}/>
      <Card title='Restaurant Manager' date='Nov, 2023 - Now days' description='A restaurant management web application focused on facilitating customer orders and restaurant organization.' tags={['Node.js', 'Angular', 'PostgreSQL']} link='https://github.com/phbrg/restaurant-manager' blank={true}/>
      <Card title='Wordle' date='Dec, 2023 - Dec, 2023' description='Guess the word by letter game made with React.js, my first React.js project.' tags={['React.js']} link='https://github.com/phbrg/wordle-react' blank={true}/>
